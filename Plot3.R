...
with(powerSub, plot(Time,Sub_metering_1, type="l", xlab="",ylab = "Energy sub metering"))
lines(powerSub$Time, powerSub$Sub_metering_2,type="l", col="red")
lines(powerSub$Time, powerSub$Sub_metering_3, type="l", col="blue")
